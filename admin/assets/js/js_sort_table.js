function js_sort_table(id,id2,col,rev) {
	var elem;
	...
	for (i = 0; i < elem.rows[0].cells.length-1 ; i++) {
		if (i==col) {
			if (rev) elem.rows[0].cells[i].className = "sortable-desc";
			else elem.rows[0].cells[i].className = "sortable-asc";
		} else elem.rows[0].cells[i].className = "sortable";	
	}
}
